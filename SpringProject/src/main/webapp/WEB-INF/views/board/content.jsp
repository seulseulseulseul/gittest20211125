...
<body>
<%
// http://localhost:8181/JspStudy/jsp5/content.jsp?num=2
...
<h1>글 내용 보기</h1>
<table border="1">
<tr><td>글번호</td><td><%=boardDTO.getNum()%></td><td>작성일</td><td><%=boardDTO.getDate()%></td></tr>
...
<tr><td>첨부파일</td><td colspan="3"><a href="../upload/<%=boardDTO.getFile()%>" download><%=boardDTO.getFile()%></a></td></tr>
